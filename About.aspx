...
<div class="container-fluid text-center">
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <h4 style="color:#fff;">POWER</h4>
      
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-heart logo-small"></span>
      <h4 style="color:#fff;">LOVE</h4>
      
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-lock logo-small"></span>
      <h4 style="color:#fff;">JOB DONE</h4>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <h4 style="color:#fff;">GREEN</h4>
      
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-certificate logo-small"></span>
      <h4 style="color:#fff;">CERTIFIED</h4>
      <p style="color:#fff;">Lorem ipsum dolor sit amet..</p>
    </div>
    <div class="col-sm-4">
      <span class="glyphicon glyphicon-wrench logo-small"></span>
      <h4 style="color:#fff;">HARD WORK</h4>
    </div>
  </div>
</div>
<footer class="container-fluid text-center">
  ...
  <p> Made By <a href="#" title="Visit w3schools"style="color:#fff;" >AZ_style</a></p>
</footer>
